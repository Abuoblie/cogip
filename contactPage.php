		...
		<form action="" method="POST">
			...
			<div
				...
				<div class="form-group mb-2">
					<label class="control-label" for="surname">Surname:</label> <input
						type="text" id="surname" required maxlength="48" name="surname"
						class="form-control" value="" placeholder="Enter your Surname">
				</div>
				<div class="form-group mb-2">
					<label class="control-label" for="firstName">First Name:</label> <input
						type="text" id="firstName" required maxlength="48"
						name="firstName" class="form-control" value=""
						placeholder="Enter your First Name">
				</div>
				<div class="form-group mb-2">
					<label class="control-label" for="phoneNumber">Phone Number:</label>
					<input type="text" id="phoneNumber" required maxlength="48"
						name="phoneNumber" class="form-control" value=""
				...
				<div class="form-group mb-2">
					<label class="control-label" for="company">Company:</label> <input
						type="text" id="company" required maxlength="48" name="company"
						class="form-control" value="" placeholder="Enter your Company">
				</div>
